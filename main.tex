...
\subsection{Distributed consensus algorithm} % TA UPP NÅGON OM VAD CONSENSUS ÄR FÖRST?
The general consensus problem can be described as a number of processes which are supposed to make a decision. Some of these processes may be unreliable which creates the need for the consensus algorithm to be fault tolerant. One way to achieve this is to choose the alternative which has the majority of the votes. % TODO: FIND REFERENCE

% TODO: OM >50% KORRUPTA AV ALLA => BROKEN SYSTEM 
